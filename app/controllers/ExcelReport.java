...
public class ExcelReport extends Controller {
	...
	public static void genCarWayBills(String startDate, String endDate,
			String customerName, String cardNO) {
		request.format = "xls";
		...
		List wayBills = models.Waybill.find(
				where == null ? null : where.toString(), null).fetch();
		renderArgs.put("__EXCEL_FILE_NAME__", "司机托运单.xls");
		render(wayBills);
	}

	public static void genWayBills(String startDate, String endDate,
			String customerName, String cardNO) {
		request.format = "xls";
